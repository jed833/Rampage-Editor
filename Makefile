...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/rampage1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/rampage1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/rampage1.0.0/ && (cd `dirname .tmp/rampage1.0.0` && $(TAR) rampage1.0.0.tar rampage1.0.0 && $(COMPRESS) rampage1.0.0.tar) && $(MOVE) `dirname .tmp/rampage1.0.0`/rampage1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/rampage1.0.0
